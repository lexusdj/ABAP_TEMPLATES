...
*      container_name =
      IMPORTING
        r_salv_table   =    me->zif_report_alv_factory_v2~m_alv_fact   " Basis Class Simple ALV Tables
          CHANGING
            t_table        = <table>
        ).
      CATCH cx_salv_msg.    "
    ...
    "get events
    me->zif_report_alv_factory_v2~m_tb_fact_evt = me->zif_report_alv_factory_v2~m_alv_fact->get_event( ).  "table cl_salv_events_table.
    me->zif_report_alv_factory_v2~m_alv_fact_evt = me->zif_report_alv_factory_v2~m_alv_fact->get_event( ). "ALV object cl_salv_events.
    "get selections
    me->zif_report_alv_factory_v2~m_selections_alv = me->zif_report_alv_factory_v2~m_alv_fact->get_selections( ).
    "get functions
    me->zif_report_alv_factory_v2~m_functions_alv = me->zif_report_alv_factory_v2~m_alv_fact->get_functions( ).
    " get sorting
    me->zif_report_alv_factory_v2~m_sorts_alv = me->zif_report_alv_factory_v2~m_alv_fact->get_sorts( ).
    "
    me->zif_report_alv_factory_v2~m_display_alv = me->zif_report_alv_factory_v2~m_alv_fact->get_display_settings( ).
    me->zif_report_alv_factory_v2~m_layout_alv = me->zif_report_alv_factory_v2~m_alv_fact->get_layout( ).

    "EVENTS to register!
    SET HANDLER me->zif_report_alv_factory_v2~on_added_function  "on user command
               FOR me->zif_report_alv_factory_v2~m_alv_fact_evt.
  ...
  ENDMETHOD.
  METHOD zif_report_alv_factory_v2~on_added_function.
  ...
  METHOD zif_report_alv_factory_v2~get_data_to_display.
    ...
    GET REFERENCE OF ct_table_data INTO zif_report_alv_factory_v2~m_output_table.
...
**      container_name =
*    IMPORTING
*      r_salv_table   =   lr_factory->zif_report_alv_factory_v2~m_alv_fact   " Basis Class Simple ALV Tables
*        CHANGING
*          t_table        = lt_output
*      ).
*    CATCH cx_salv_msg.    "
...
*
*  "get events
*  lr_factory->zif_report_alv_factory_v2~m_tb_fact_evt = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_event( ).
*  lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_event( ).
*  "get selections
*  lr_factory->zif_report_alv_factory_v2~m_selections_alv = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_selections( ).
*  "get functions
*  lr_factory->zif_report_alv_factory_v2~m_functions_alv = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_functions( ).
*  " get sorting
*  lr_factory->zif_report_alv_factory_v2~m_sorts_alv = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_sorts( ).
*  "
*  lr_factory->zif_report_alv_factory_v2~m_display_alv = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_display_settings( ).
*  lr_factory->zif_report_alv_factory_v2~m_layout_alv = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_layout( ).
*
*  "EVENTS to register!
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_added_function  "on user command
*             FOR lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt.
*
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_after_salv_function
*             FOR lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt.
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_before_salv_function
*             FOR lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt.
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_end_of_page
*            FOR lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt.
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_top_of_page
*            FOR lr_factory->zif_report_alv_factory_v2~m_alv_fact_evt.
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_double_click
*            FOR lr_factory->zif_report_alv_factory_v2~m_tb_fact_evt.
*  SET HANDLER lr_factory->zif_report_alv_factory_v2~on_link_click
*            FOR lr_factory->zif_report_alv_factory_v2~m_tb_fact_evt.

  " work on columns settings
  DATA lr_column  TYPE REF TO cl_salv_column_table.
  DATA(gr_columns) = lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_columns( ).
  TRY.
      "hide columns
  ...
  lr_factory->zif_report_alv_factory_v2~m_alv_fact->set_screen_status(
    pfstatus      = 'DISP_MAIN'
    report        = sy-repid
    set_functions = cl_salv_model_base=>c_functions_all ).

  DATA lo_functions TYPE REF TO cl_salv_functions_list.
  lo_functions =  lr_factory->zif_report_alv_factory_v2~m_alv_fact->get_functions( ).
  lo_functions->set_default( ).
  lo_functions->set_group_export( ).

  lr_factory->zif_report_alv_factory_v2~get_data_to_display( CHANGING ct_table_data = lt_output  ). "gt_output ).
  lr_factory->zif_report_alv_factory_v2~m_alv_fact->display( ).
